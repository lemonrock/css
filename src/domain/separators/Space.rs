...
/// Type used as the associated type in the `OneOrMoreSeparated` trait on a type to indicate that a serialized list of elements of this type separated by spaces.
